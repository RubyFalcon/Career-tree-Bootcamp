...
# save transactions
def save_transaction(transaction_type, category, amount, filename=DATA_FILE):
    """
    ...
    line = f"{timestamp},{transaction_type},{category},{amount:.2f}\n"

    with open(filename, "a", encoding="utf-8") as f:
        f.write(line)

    print(f"{transaction_type} of £{amount: .2f} recorded successfully")
def add_income():
